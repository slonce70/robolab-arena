...
Build a browser-based 3D adventure shooter for a 9-year-old first-time creator. The game should feel playful, bright, and immediately understandable: move a small robot through lab rooms, shoot energy projectiles, solve simple room challenges, and beat a mini-boss.
...
The player is Blitz, a small inventor robot inside a colorful training lab. Each chamber is a playful test with drones, buttons, lasers, energy doors, collectible gears, and a boss guardian.

## First Version Scope

- 3D browser game built with Vite, TypeScript, and Three.js.
- Eight compact lab chambers.
- Third-person angled camera.
- Keyboard movement and mouse aiming.
- Energy blaster shooting.
- Enemies, targets, buttons, lasers, doors, collectibles, power-ups, and a boss.
...
- Important information should fit into compact edge HUD elements: level, energy, score, power-ups, and progress.
...
- Power-ups should be visually distinct: repair is green, rapid blaster is yellow, shield is cyan.
